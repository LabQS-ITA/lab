...
ALLOWED_HOSTS = ['test.labqs.ita.br']
...
DATABASE = {
    ...
    'PASSWORD': 'a5c7a2940a7cb7aa',           # PostgreSQL password
...
SECRET_KEY = 'sL8VI(9V_MYMKo^WVAFnC8Fw1ZGOLeenQMx9O#%L^xkFRQ+7IN'
